...
/*
 *    KMeans++ Modified from SimpleKMeans.java
 ...
 */
public class KMeansPlusPlusSC extends RandomizableClusterer implements
  ...
  public static final Tag[] TAGS_SELECTION = { new Tag(RANDOM, "Random"),
    new Tag(KMEANS_PLUS_PLUS, "k-means++") };

  /** The initialization method to use */
  protected int m_initializationMethod = KMEANS_PLUS_PLUS;
  ...
  public String initializationMethodTipText() {
    return "The initialization method to use k-means++";
  }
  ...
  /**
   * Gets the current settings of KMeansPlusPlus.
   * 
  ...
  public String toString() {
    ...
    temp.append("\nkMeans Clustering (Modified By Fahmi) \n==================================\n");
    temp.append("\nNumber of iterations: " + m_Iterations);

    if (!m_FastDistanceCalc) {
      temp.append("\n");
      if (m_DistanceFunction instanceof EuclideanDistance) {
        temp.append("Within cluster sum of squared errors (WCSS/SSE): "
    ...
    // Silhouette Coefficient
    temp.append("\nRata-Rata Nilai Silhouette Coefficients (SC) : " + AvgSilCoeff);
  ...
  public static void main(String[] args) {
    runClusterer(new KMeansPlusPlusSC(), args);
  }
}
